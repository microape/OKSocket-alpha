package com.microape.easyble.client.impl.client;

import com.microape.easyble.client.impl.client.action.ActionHandler;
import com.microape.easyble.client.impl.client.iothreads.IOThreadManager;
import com.microape.easyble.client.impl.exceptions.ManuallyDisconnectException;
import com.microape.easyble.client.impl.exceptions.UnConnectException;
import com.microape.easyble.client.sdk.client.ConnectionInfo;
import com.microape.easyble.client.sdk.client.OkSocketOptions;
import com.microape.easyble.client.sdk.client.OkSocketSSLConfig;
import com.microape.easyble.client.sdk.client.action.IAction;
import com.microape.easyble.client.sdk.client.connection.AbsReconnectionManager;
import com.microape.easyble.client.sdk.client.connection.IConnectionManager;
import com.microape.easyble.common.common_interfacies.IIOManager;
import com.microape.easyble.common.default_protocol.DefaultX509ProtocolTrustManager;
import com.microape.easyble.common.utils.TextUtils;
